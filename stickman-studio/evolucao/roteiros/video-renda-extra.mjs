...
await gerar({
  ...
  cenas: [
    { tipo: 'andar', dur: 3000, cena: 'rua', titulo: 'Mais de uma renda', leg: 'Depender de um salário só é um risco escondido.' },
    ...
    { tipo: 'fala', dur: 2800, cena: 'banco', expr: 'neutro', g: G.REFLETE, leg: 'Troque tempo por dinheiro — mas mire renda que escala.' },
    { tipo: 'andar', dur: 2600, cena: 'rua', leg: 'Reinvista a renda extra; não inche o padrão de vida.' },
    { tipo: 'fala', dur: 2800, cena: 'mercado', expr: 'feliz', prop: 'nota', g: G.MOSTRA, leg: 'Comece pequeno, com algo que você já sabe fazer.' },
